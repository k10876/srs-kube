...
**Step 3:** Run workflow from [Actions](https://github.com/k10876/srs-kube/actions/workflows/kubernetes.yml) to deploy to your K8s, for example, if your external IP is `81.70.125.89`:
